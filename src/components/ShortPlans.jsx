...
const ShortPlans = () => {
    ...
    return (
        <div className='relative bg-[rgb(29,70,30)] min-h-screen  text-white'>
            ...
            {planPurchaseShow ?
                <div className='absolute w-[40%]  top-[450px] rounded-lg shadow-xl  z-10 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                    <div className='flex flex-col justify-center gap-3 h-[180px] shadow-2xl border border-gray-300 items-center bg-white w-full text-cyan-400 rounded-xl'>
                        ...
                        <div className='text-sm text-center font-extrabold'>Successful Purchase</div>
                    </div>
                </div>
                :
                null}
