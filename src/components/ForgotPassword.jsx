...
const ForgotPassword = () => {
    ...
    return (
        <div className='bg-[#0373bd] min-h-screen relative'>
            ...
            {/* [#d3d6fe] */}
            <div className="box mb-20 gap-2 m-auto bg-[#0373bd] rounded-md mt-6 border-solid lg:w-3/5 w-[86%]  p-4 w-50% flex flex-col">
