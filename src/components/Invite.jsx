...
const Invite = () => {
    ...
    if (loading || userDetails === null) {
        return (
            <div className=' bg-[#01455c] min-h-screen flex flex-col text-white font-light  relative'>
    ...
    //[#2e9afe]
    return (
        <div className=' bg-[#01455c]  flex flex-col text-white font-light relative'>
