...
const Team = () => {
  ...
  if (loading || userDetails === null) {
    return (
      <div className='bg-[#34b0a9] min-h-screen overflow-x-hidden text-white'>
        {/* [#2e9afe] */}
  ...
  return (
    <div className='bg-[#34b0a9] min-h-screen overflow-x-hidden text-white'>
      ...
      {/* <div className="flex flex-row justify-between items-center p-2 border-b-[0.5px] border-gray-200" >
        ...
        <div>
          <button className="bg-[#34b0a9] text-white text-xs px-2 rounded-full py-[3px] flex items-center gap-1">
