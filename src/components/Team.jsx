...
const Team = () => {
  ...
  if (loading || userDetails === null) {
    return (
      <div className='bg-[#01455c] min-h-screen overflow-x-hidden text-white'>
        {/* [#2e9afe] */}
        ...
        <div className='flex flex-col items-center w-full   bg-[#01455c] '>
          <div className="flex items-center w-full px-4 bg-[#01455c] font-[300] mt-3">
  ...
  return (
    <div className='bg-[#01455c] min-h-screen overflow-x-hidden text-white'>
      ...
      {/* <div className="flex flex-row justify-between items-center p-2 border-b-[0.5px] border-gray-200" >
        ...
        <div>
          <button className="bg-[#01455c] text-white text-xs px-2 rounded-full py-[3px] flex items-center gap-1">
