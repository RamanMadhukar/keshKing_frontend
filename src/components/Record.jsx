...
const Record = () => {
    ...
    //[#2e9afe]
    return (
        <div className=' bg-[#34b0a9] min-h-screen w-full pb-3 sm:h-[1000px] md:h-screen h-screen'>
            ...
            {/* <div className='flex flex-wrap items-center justify-between py-2 px-4 bg-white border-b border-gray-400'>
                ...
                <button className='bg-[#34b0a9] shadow-lg w-20 text-center  ml-3 text-white rounded-full py-1'>Search</button>
            </div> */}
            {/* [#bce4ed] */}
            <div className='records w-full flex  bg-[#34b0a9] font-normal items-center rounded-lg mt-3'>
            ...
            <div className='h-[500px] my-5 mx-1'>
                {(currentRecord === 'recharges' || currentRecord === 'all') && recharge_list && recharge_list.map((element, id) => {
                    // red-800
                    return (
                        <div key={id} className="bg-[#34b0a9] rounded-lg shadow-md p-2 text-white mt-2 mx-2">
                            <div className='flex justify-between items-start'>
                                ...
                                <div>
                                    <div className='bg-[#34b0a9] px-2 py-1 font-semibold rounded-md text-sm text-white'>{nameMapper[String(element.status)]}</div>
                                </div>
