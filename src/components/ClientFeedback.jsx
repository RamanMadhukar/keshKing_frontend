...
const ClientFeedback = () => {
    ...
    //[#2e9afe]
    return (
        <div className='min-h-screen bg-[#34b0a9] h-screen flex flex-col text-white font-light relative'>
            {toasterShow ? <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                <div className='flex gap-2 bg-black opacity-100 text-white px-2 py-1 rounded-md'>
                    <div>{toasterText}</div>
                </div>
            </div> : null}
            <div className="top p-3 cursor-pointer flex items-center bg-[#34b0a9]">
            ...
            <div className='box gap-3 flex flex-col text-gray-500 p-6 font-semibold bg-[#fafff9] rounded-xl  shadow-xl m-4 border border-gray-300'>
                <div className='w-full px-2 py-2 font-bold text-lg' > * Please enter the feedback details.</div>
