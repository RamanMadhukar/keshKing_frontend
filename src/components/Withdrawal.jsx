...
const Withdrawal = () => {
    ...
    //[#2e9afe]
    return (
        <div className='bg-[#01455c] min-h-screen flex flex-col  sm:h-[1000px] md:h-[950px] relative'>
            ...
            <div className="part1 bg-white p-3 rounded-lg mx-3 mt-3">
                ...
                <div className='flex items-center justify-start gap-2 mt-4 mb-1'>
                    ...
                    <div onClick={handleWithdrawalAll} className="withdraw bg-[#01455c] font-medium rounded-sm
